...
public class TrackDetailAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.numberTextView = (TextView) convertView.findViewById(R.id.detail_item_textView1);
            holder.titleTextView = (TextView) convertView.findViewById(R.id.detail_item_textView2);
            holder.subTitleTextView = (TextView) convertView.findViewById(R.id.detail_item_textView3);
